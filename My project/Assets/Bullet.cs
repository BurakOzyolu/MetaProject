...
public class Bullet : MonoBehaviour
{
    ...
    [SerializeField] ParticleSystem playerDeathParticle; //Oyuncu ölürken calisan efekt degiskeni
    ...
    private void OnCollisionEnter2D(Collision2D collision) 
    {
        ...
        //Merminin carpýgý yer ground ise;
        if (collision.gameObject.CompareTag("Ground")) 
        {
            Instantiate(groundParticle, transform.position, Quaternion.identity); //Yere çarptýðý zaman, Ground Efektini oluþturuyoruz
        }
    }
}
